# CLI client for lab6-server

## Usage

```shell
Usage: lab6-client.jar [options]
  Options:
  * -c, -command
      Command name
...
```shell
java -jar .\lab6-client\target\lab6-client.jar \
    -url http://localhost:9596/lab6-server \
    -c find \
    -area 98 \
    -limit 1 \
    -offset 10
