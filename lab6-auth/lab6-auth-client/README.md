# CLI client for lab6-auth-server

## Usage

```shell
Usage: lab6-auth-client.jar [options]
  Options:
  * -c, -command
      Command name
...
```shell
java -jar .\lab6-auth-client\target\lab6-auth-client.jar \
    -url http://localhost:9596/lab6-auth-server \
    -c find \
    -area 98 \
    -limit 1 \
    -offset 10
