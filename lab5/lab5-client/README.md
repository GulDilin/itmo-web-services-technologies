# CLI client for lab5-server

## Usage

```shell
Usage: lab5-client.jar [options]
  Options:
  * -c, -command
      Command name
...
```shell
java -jar .\lab5-client\target\lab5-client.jar \
    -url http://localhost:9596/lab5-server \
    -c find \
    -area 98 \
    -limit 1 \
    -offset 10
